 ...
 */
var insertOne = function (c, doc, opts) {
    if (opts === void 0) { opts = {}; }
 ...
 */
var insertMany = function (c, docs, opts) {
    if (opts === void 0) { opts = {}; }
 ...
 */
var findOne = function (c, qry, opts) {
    if (opts === void 0) { opts = {}; }
 ...
 */
var findOneAndUpdate = function (c, filter, update, opts) {
    if (opts === void 0) { opts = {}; }
 ...
 * documents.
 */
var updateOne = function (c, qry, updateSpec, opts) {
    if (opts === void 0) { opts = {}; }
 ...
 * documents.
 */
var updateMany = function (c, qry, updateSpec, opts) {
    if (opts === void 0) { opts = {}; }
 ...
 */
var deleteOne = function (c, qry, opts) {
    if (opts === void 0) { opts = {}; }
 ...
 */
var deleteMany = function (c, qry, opts) {
    if (opts === void 0) { opts = {}; }
 ...
 */
var aggregate = function (c, p, opts) {
    if (opts === void 0) { opts = {}; }
 ...
 */
var populate = function (c, ref, mData, fields) {
    var _a, _b;
    ...
    if (Array.isArray(data[ref[0]])) {
        return exports.find(c, (_a = {}, _a[ref[1]] = { $in: data[ref[0]] }, _a), { projection: fields })
            .chain(function (mr) {
            if (!array_1.empty(mr))
                data[ref[0]] = mr;
            else
        ...
        return exports.findOne(c, (_b = {}, _b[ref[1]] = data[ref[0]], _b), { projection: fields })
            .chain(function (mr) {
            if (mr.isJust())
                data[ref[0]] = mr.get();
            else
 ...
 * of 100 by default.
 */
var populateN = function (c, refs, data, fields, n) {
    if (n === void 0) { n = 100; }
 ...
 * version > 2.6
 */
var createIndexes = function (c, specs, opts) {
    if (opts === void 0) { opts = {}; }
    return future_1.fromCallback(function (cb) {
